...
public class TemplateServiceTests
{
    ...
    {
        TemplateService = new TemplateService(new JsonParserService());
    }

    [Theory]
    [MemberData(nameof(GetAllPlaceholdersData))]
    public void GetAllPlaceholders(string template, string[] expected)
    {
    ...
    public static IEnumerable<object[]> GetAllPlaceholdersData
        => new List<object[]>
        {
            new object[]
            {
                "Weather in {{city placeholder}} is {{forecast description}}. Temperature is {{temperature}}",
                new[] { "city placeholder", "forecast description", "temperature" }
            },
            new object[]
            {
                "{{placeholder1}}",
    ...
    [Theory]
    [MemberData(nameof(BuildTemplateFromJsonData))]
    public void BuildTemplateFromJson(string template, string json, string expected)
    {
    ...
    public static IEnumerable<object[]> BuildTemplateFromJsonData
        => new List<object[]>
        {
            new object[]
            {
                ...
                "Weather from the source Weatherapi for location Portugal Lisbon. Temperature is 27.0 C (feels like 27.0 C). Partly cloudy. Wind speed 22.0 kilometers per hour."
            },
            new object[]
            {
                ...
                "Weather from the source Visualcrossing for location Lisboa, Portugal. Temperature is 21.8 C (feels like 21.8 C). Clear conditions throughout the day. Wind speed 20.5."
            },
            new object[]
            {
                ...
                "Weather from the source OpenWeatherMap for location PT Lisbon. Temperature is 300.09 F (feels like 300.34 F). few clouds. Wind speed 8.75."
            },
            new object[]
            {
                ...
                "Weather from the source Tomorrow.io for location Lisboa, Portugal. Temperature is 28 C (feels like 27.95 C). Wind speed 4.63 kilometers per hour."
            },
            new object[]
            {
                ...
                "Weather from the source Weatherbit.io for location PT Lisbon. Temperature is 27 C (feels like 27.1 C). Clear sky. Wind speed 5.7 kilometers per hour."
            },
            new object[]
            {
                ...
                "Weather from the source WeatherStack for location Portugal Lisbon. Temperature is 27 C (feels like 27 C). Partly cloudy. Wind speed 20 kilometers per hour."
            }
        };
}